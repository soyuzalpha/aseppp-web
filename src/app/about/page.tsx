...
const EDU = [
  { period: "2017 – 2021", degree: "S1 Informatics", school: "University" },
];
  ...
  return (
    <div ref={pageRef}>
      <main style={{ paddingTop: "5rem" }}>
        ...
        >
          <p className="type-label mb-3" style={{ color: "var(--color-accent)" }}>About</p>
        ...
        >
          ...
          <div>
            ...
            >
              I&apos;m a fullstack developer from Bandung, Indonesia. I care deeply
              about the work — not just shipping things, but shipping things right.
              That means clean architecture, thoughtful APIs, accessible interfaces,
              and code that future-me won&apos;t curse.
            </p>
            <p className="type-body" style={{ color: "var(--color-mutedForeground)", maxWidth: "54ch" }}>
              I specialize in the Node.js + React ecosystem but I&apos;m not religious
              about tools — I use what makes the product better.
              Currently open to new projects and full-time roles.
            </p>
        ...
        <div
          className="col"
          style={{ paddingBlock: "3.5rem", borderBottom: "1px solid var(--color-border)" }}
        >
        ...
        >
          ...
          {EXP.map((e, i) => (
            ...
            >
              ...
              <span className="type-index" style={{ textAlign: "right" }}>{e.co}</span>
            </div>
          ))}
        </div>
        ...
        <div className="col" style={{ paddingBlock: "3.5rem" }}>
          ...
          {EDU.map((e, i) => (
            ...
            >
              ...
              <span className="type-index" style={{ textAlign: "right" }}>{e.school}</span>
            </div>
          ))}
        </div>
